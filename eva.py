...
if _name_ == '_main_':
	...
	while True:
		...
		if 'wikipedia' in query:
			...
			speak("I am your virtual assistant created by AYUSH")
			...
			speak("for how much time you want to stop EVA from listening commands")
			a = int(takeCommand())
			time.sleep(a)
			print(a)
		...
		# NPPR9-FWDCX-D2C8J-H872K-2YT43
			...
			wishMe()
			speak("EVA in your service Mister")
			speak(assname)
